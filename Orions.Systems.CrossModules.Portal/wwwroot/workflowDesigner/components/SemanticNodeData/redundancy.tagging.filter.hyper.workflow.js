var component = (function(){
    ...
    var readme = `# RedundancyTaggingFilterHyperWorkflowNodeData  

  Serialized via a Memento. `;

    return {
        id: 'redundancytaggingfilterhyperworkflownodedata',
        typeFull: 'Orions.Infrastructure.HyperSemantic.RedundancyTaggingFilterHyperWorkflowNodeData',
        title : 'Redundancy Tagging Filter',
