...
var component = (function(){
    ...
    var readme = `# RuntimePreviewHyperWorkflowNodeData_GetTags  

  Message sent directly to the Preview Node instance. `;

    return {
        id: 'runtimepreviewhyperworkflownodedata',
        typeFull: 'Orions.Infrastructure.HyperSemantic.RuntimePreviewHyperWorkflowNodeData_GetTags',
