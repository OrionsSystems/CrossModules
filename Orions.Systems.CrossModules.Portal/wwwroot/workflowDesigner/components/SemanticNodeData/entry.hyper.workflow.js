...
var component = (function(){
    ...
    var readme = `# EntryHyperWorkflowNodeData   `;

    return {
        id: 'entryhyperworkflownodedata',
        typeFull: 'Orions.Infrastructure.HyperSemantic.EntryHyperWorkflowNodeData',
        title : 'Entry Hyper Workflow',
